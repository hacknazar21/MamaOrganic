        ...
        <>
            <section className="page__popular popular">
                <div className="popular__header">
                    <h2 className="popular__title section-title">Популярные товары</h2>
                </div>
                            ...
                            <div className="popular-product__content-box product-content-box">
                                ...
                                <div className="popular-product__info product-info">
                                    <div className="popular-product__price product-price">
                                        <div className="product-price__current product-price__current">3 600 тг</div>
                                        <div className="product-price__old product-price__old">4 600 тг</div>
                                    </div>
                                    <div className="popular-product__rating product-rating">
                                        <Rating readonly={true} emptySymbol={'rating-item'} initialRating={3} fullSymbol={'rating-item-fill'}/>
